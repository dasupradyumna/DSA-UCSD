...
fn main() {
    ...
    for t in 1..=n_tests {
        ...
        let slow = _maximum_pairwise_product_slow(&seq);
...
fn _maximum_pairwise_product_fast(sequence: &Vec<i32>) -> i64 {
...
fn _maximum_pairwise_product_slow(sequence: &Vec<i32>) -> i64 {
    sequence
        .iter()
        .enumerate()
